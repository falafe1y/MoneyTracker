...
Она не хранит пополнения, операции, даты взносов или факт достижения.
Достижение пересчитывается при обновлении курсов, котировок и балансов;
при падении капитала статус снова становится незавершённым.
Фильтры дат и активов из обзора не влияют на цели. Будущие операции не входят
в текущий капитал. Основная валюта интерфейса не меняет валюту цели.

Можно учитывать весь капитал или выбранные счета и криптокошельки.
Кредитный лимит не считается собственными деньгами; задолженность уменьшает
капитал. Цели независимы и не резервируют деньги. При недоступном источнике,
балансе или котировке расчёт помечается неполным без подтверждения достижения.
Срок необязателен, действует включительно и не останавливает пересчёт.
Удаление цели не изменяет счета и операции.

Для новых редактируемых сущностей используйте один диалог для создания и
редактирования, отдельное подтверждение удаления и общую палитру приложения.
